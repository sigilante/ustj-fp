...
\fancyfoot[L]{{\footnotesize
              ...
              ~ \\
              Address author correspondence to \texttt{davis68@illinois.edu, rshosted@illinois.edu}.
              }}
}
%  Arrange subsequent pages:
\fancyhf{}
\fancyhead[LE]{{\it A Fixed and Unalterable Sound}}
\fancyhead[RO]{The Promise and Praxis of the Deseret Alphabet}
...
% $2^{-23} \times 2^{-63} \approx 1.084 \times 10^{-19}$.
% SEEE.EEEE.EFFF.FFFF.FFFF.FFFF.FFFF.FFFF

This variable precision means that the precision of floating-point values varies across the range of representable numbers.  (See the paragraph on “operations beyond the horizon” below.)
% https://www.h-schmidt.net/FloatConverter/IEEE754.html

\paragraph{Machine epsilon}.
The machine epsilon for a particular bit width is determined by setting two to the negative power of the number of bits used for the magnitude of the mantissa; for 32-bit single-precision \texttt{float} this is $2^{-24} = \texttt{0000.0000.0000.0000.0000.0000.0000.0000}
$

\paragraph{Operations beyond the horizon}.
Operations between two numbers of fairly different precisions are particularly vulnerable to accuracy loss, although some numerical techniques can be employed to mitigate.  For example, 
...
% Axelrod2006 https://www.jasss.org/9/4/4.html

Some numbers which do not 
0.1 etc. shift w/ bit loss
...
% TODO move this paragraph downchannel and mine Dawson
...
TODO
% https://bebop.cs.berkeley.edu/reproblas/index.php
