...
\fancyfoot[L]{{\footnotesize
              ...
              {\it Urbit Systems Technical Journal} I:1 (2024):  93–131. \\
              ~ \\
...
Since the {\sc ieee} 754 floating-point format packs values of different kind together bitwise, conventional integer operations such as left shift $<<$ and addition $+$ do not trivially apply.\footnote{For instance, left-shifting \texttt{1.0} does not result in \texttt{2.0} but \texttt{1.7014118e38}; we leave the mathematics of why as an exercise to the reader.}
...
\section{Urbit's Implementation of \textsc{\textbf{ieee}} 754}
